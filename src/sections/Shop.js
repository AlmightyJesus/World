  ...
  return (
    <Section ref={ref} id="shop">
      ...
      <Right ref ={horizontalRef}>
          <Product img={img1} title="New"/>
          <Product img={img2} title="Collection"/>
          <Product img={img3} title="Is"/>
          <Product img={img4} title="Out"/>
          <Product img={img5} title="Now"/>
          <Product img={img6} title="Give"/>
          <Product img={img7} title="It"/>
          <Product img={img8} title="A"/>
          <Product img={img9} title="Try"/>
          <Product img={img10} title="Thanks"/>
      </Right>
    </Section>
  );
};
